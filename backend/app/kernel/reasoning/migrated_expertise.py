...
from app.intelligence.causal.rules import ExpertiseRuleProvider

def wrap_expertise_rules() -> List[ReasoningRule]:
    provider = ExpertiseRuleProvider()
    rules = []
...
class ExpertiseReasoningProvider:
    @property
    def name(self) -> str: return "expertise"
    def rules(self) -> List[ReasoningRule]: return wrap_expertise_rules()
